<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-02-25 12:09:54
         compiled from "D:\xampp\htdocs\uploads\app\template\admin\web_config.htm" */ ?>
<?php /*%%SmartyHeaderCode:5056045395a92371298b4e8-12515212%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0bd79b5243ea172e0a6ac1adac48e5598c69fff7' => 
    array (
      0 => 'D:\\xampp\\htdocs\\uploads\\app\\template\\admin\\web_config.htm',
      1 => 1517996444,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5056045395a92371298b4e8-12515212',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a923712a8e119_41099458',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a923712a8e119_41099458')) {function content_5a923712a8e119_41099458($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
            ...
            <tr class="admin_table_trbg">
              ...
              <td>
                <div class="layui-form-item">
                  <div class="layui-input-block">
                    <div class="layui-input-inline">
                      <input type="checkbox" name="sy_wap_jump" lay-skin="switch" lay-text="开启|关闭"
                        <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_wap_jump']=="1") {?>
                       checked
                        <?php }?>
                        />
                    </div>
...
"
            ...
            <tr class="admin_table_trbg">
              ...
              <div class="layui-form-item">
                  <div class="layui-input-block">
                    <div class="layui-input-inline">
                      <input name="sy_day_ask_num" id="sy_day_ask_num"
                       placeholder="请输入" autocomplete="off" class="layui-input" type="text" 
                       value="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_day_ask_num'];?>
"
                       size="30" maxlength="255" 
                       onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
                    </div>
            ...
            <tr class="admin_table_trbg">
              ...
              <td>
                <div class="layui-form-item">
                  <div class="layui-input-block">
                    <div class="layui-input-inline">
                      <input type="checkbox" name="ask_check" lay-skin="switch" lay-text="开启|关闭"
                        <?php if ($_smarty_tpl->tpl_vars['config']->value['ask_check']=="1") {?>
                       checked
                        <?php }?>
                        />
                    </div>
                    <div class="layui-form-mid layui-word-aux">
                      开启后，发布的问题默认未审核。关闭审核则发布的问题默认审核通过。
                    </div>
                  </div>
                </div>  
              </td>
...
" size="10" /><span class="admin_web_tip">最小为1，最大为100，每次在1-X范围随机增加</span></td>
             ...
             <th>&nbsp;</th>
          <td align="left">
                  <input class="admin_button admin_buttonpz" id="config" lay-submit="" lay-filter="demo1" type="button" name="config" value="提交" />&nbsp;&nbsp;
