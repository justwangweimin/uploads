<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-02-25 12:09:10
         compiled from "D:\xampp\htdocs\uploads\app\template\admin\admin_news_add.htm" */ ?>
<?php /*%%SmartyHeaderCode:4116003115a9236e6318b32-01119736%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aec84260b69c8f2777ffc32d743f55dcdfdac05b' => 
    array (
      0 => 'D:\\xampp\\htdocs\\uploads\\app\\template\\admin\\admin_news_add.htm',
      1 => 1518147327,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4116003115a9236e6318b32-01119736',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9236e64e1de1_64309566',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9236e64e1de1_64309566')) {function content_5a9236e64e1de1_64309566($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
>
        ...
        <tr >
          <th>缩 略 图：</th>
          <td>
		  <button type="button" class="yun_bth_pic adminupload" lay-data="{name: 'newsphoto',imgnews: 'imgicon',imgthumb: 's_thumb'}">上传图片</button>
			
			<input type="hidden" id="layupload_type" value="2"/>
			<input type="hidden" id="upload_path" value="news"/>

			<input type="hidden" name="newsphoto" value="<?php echo $_smarty_tpl->tpl_vars['info']->value['newsphoto'];?>
"/>
			<input type="hidden" name="s_thumb" value="<?php echo $_smarty_tpl->tpl_vars['info']->value['s_thumb'];?>
"/>
			<a id="imgicon" href="javascript:void(0)" onClick="news_preview('<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/<?php echo $_smarty_tpl->tpl_vars['info']->value['newsphoto'];?>
')" class="admin_chlose_img_look <?php if (!$_smarty_tpl->tpl_vars['info']->value['newsphoto']) {?>none<?php }?>">查看图片</a>
         </tr>
