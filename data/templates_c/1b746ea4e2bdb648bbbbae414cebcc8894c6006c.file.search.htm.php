<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-02-26 12:49:36
         compiled from "D:\xampp\htdocs\uploads\app\template\default\resume\search.htm" */ ?>
<?php /*%%SmartyHeaderCode:8454911905a9391e0583ae2-73486177%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1b746ea4e2bdb648bbbbae414cebcc8894c6006c' => 
    array (
      0 => 'D:\\xampp\\htdocs\\uploads\\app\\template\\default\\resume\\search.htm',
      1 => 1517902147,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8454911905a9391e0583ae2-73486177',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9391e32d37e0_51985211',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9391e32d37e0_51985211')) {function content_5a9391e32d37e0_51985211($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\xampp\\htdocs\\uploads\\app\\include\\libs\\plugins\\function.url.php';
...
<?php $userrec=array();global $db,$db_config,$config;
		...
		eval('$paramer=array("limit"=>"18","post_len"=>"18","rec_resume"=>"1","item"=>"\'userrec\'","nocache"=>"")
;');
		$ParamerArr = GetSmarty($paramer,$_GET,$_smarty_tpl);
		$paramer = $ParamerArr[arr];
		$Purl =  $ParamerArr[purl];
...
global $config;eval('$paramer=array("limit"=>"14","recom"=>"1","type"=>"5","item"=>"\'keylist\'","nocache"=>"")
;');$list=array();
...
$_smarty_tpl->tpl_vars['v']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['v']->key;
?>
                <li><a href="javascript:;" onclick="showurl('<?php echo smarty_function_listurl(array('m'=>'resume','type'=>'exp','v'=>$_smarty_tpl->tpl_vars['v']->value),$_smarty_tpl);?>
')"><?php echo $_smarty_tpl->tpl_vars['userclass_name']->value[$_smarty_tpl->tpl_vars['v']->value];?>
</a></li>
                <?php } ?>
              </ul>
  ...
  <div class="search_h1_box">
    <div class="search_h1_box_title">
      <ul class="search_h1_box_list">
        <li <?php if ($_GET['pic']=='') {?>class="search_job_all "<?php }?> class="search_job_all "><a href="<?php echo smarty_function_url(array('m'=>'resume','c'=>'search'),$_smarty_tpl);?>
">所有人才</a><i class="search_h1_box_list_icon"></i></li>
        <li <?php if ($_GET['pic']) {?>class="search_h1_box_cur "<?php }?> class="job_tj_t  "><a href="<?php echo smarty_function_listurl(array('m'=>'resume','type'=>'tp','v'=>1),$_smarty_tpl);?>
" style="color:#1296db">照片人才<i class="job_tj_chk"></i>
              <i class="job_zp_icon"></i></a>  </li>
      </ul>
...
',2);"/></a>
	...
	<i class="resume_list_xb resume_list_xb <?php if ($_smarty_tpl->tpl_vars['user2']->value['sex']=='女') {?>resume_list_xb_nv<?php }?>"></i>
      ...
      <div class="usersearch_job_left_siaber" style="width:450px;"> <a href="<?php echo smarty_function_url(array('m'=>'resume','c'=>'show','id'=>$_smarty_tpl->tpl_vars['user2']->value['id']),$_smarty_tpl);?>
" target="_blank" class="fl user_name">  <?php if (in_array($_smarty_tpl->tpl_vars['user2']->value['id'],$_smarty_tpl->tpl_vars['eid']->value)) {
echo $_smarty_tpl->tpl_vars['user2']->value['uname'];
} else {
echo $_smarty_tpl->tpl_vars['user2']->value['username_n'];
}?></a> 
    <span class="user_listinfo fl"><?php if ($_smarty_tpl->tpl_vars['user2']->value['age']==0) {?>保密<?php } else {
echo $_smarty_tpl->tpl_vars['user2']->value['age'];?>
岁<?php }?><i class="user_listinfo_line">|</i><?php echo $_smarty_tpl->tpl_vars['user2']->value['exp_n'];?>
经验<i class="user_listinfo_line">|</i><?php echo $_smarty_tpl->tpl_vars['user2']->value['edu_n'];?>
学历 </span>
...
/images/tui.png" title="站长推荐"/><?php }?>
              ...
              <div class="user_listinfo_city">期望地点：<?php echo $_smarty_tpl->tpl_vars['user2']->value['job_city_one'];?>
-<?php echo $_smarty_tpl->tpl_vars['user2']->value['job_city_two'];?>
</div>
              
              <div class="user_listinfo_job">期望职位： 		
...
?>
			<?php if ($_smarty_tpl->tpl_vars['key']->value<5) {?>
			  <li class="user_tag_user_a">
			<i class="user_tag_user_icon"></i><?php echo $_smarty_tpl->tpl_vars['v']->value;?>
         ...
         <?php }?>
          ...
          <div class="user_want">TA想找<span class="user_want_s"><?php echo $_smarty_tpl->tpl_vars['user2']->value['name'];?>
</span>工作</div> 
      <div class="yun_look_right">
      <span class="yun_look_time"><img src="<?php echo $_smarty_tpl->tpl_vars['style']->value;?>
/images/Top.gif"></span>
...
',2);"/>
      ...
      <div class="usersearch_job_left_siaber" style="width:450px"> 
		<a href="<?php echo smarty_function_url(array('m'=>'resume','c'=>'show','id'=>$_smarty_tpl->tpl_vars['user']->value['id']),$_smarty_tpl);?>
" target="_blank" class="fl user_name">
			<?php if (in_array($_smarty_tpl->tpl_vars['user']->value['id'],$_smarty_tpl->tpl_vars['eid']->value)) {?>
				<?php echo $_smarty_tpl->tpl_vars['user']->value['uname'];?>
      ...
      <span class="user_listinfo fl"><?php if ($_smarty_tpl->tpl_vars['user']->value['age']==0) {?>保密<?php } else {
...
/images/profile.png" title="有形象照" class="user_rz_img png fl"/><?php }?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['job_list']->value['rec_time']>time()) {?><img width="15" height="15" src="<?php echo $_smarty_tpl->tpl_vars['style']->value;?>
/images/tui.png" title="站长推荐"/><?php }?>
      <div class="user_listinfo_city">期望地点：<?php echo $_smarty_tpl->tpl_vars['user']->value['job_city_one'];?>
-<?php echo $_smarty_tpl->tpl_vars['user']->value['job_city_two'];?>
</div>
      <div class="user_listinfo_job">期望职位： <?php if ($_smarty_tpl->tpl_vars['user']->value['expectjob']) {?>
...
?>
			<?php if ($_smarty_tpl->tpl_vars['key']->value<5) {?>
		  <li class="user_tag_user_a"><i class="user_tag_user_icon"></i>
			<?php echo $_smarty_tpl->tpl_vars['v']->value;?>
    ...
    <div class="user_want">TA想找<span class="user_want_s"><?php echo $_smarty_tpl->tpl_vars['user']->value['name'];?>
</span>工作</div> 
      <div class="yun_look_right">
      <span class="yun_look_time"><?php if ($_smarty_tpl->tpl_vars['user']->value['redtime']==1||$_smarty_tpl->tpl_vars['user']->value['time']=='昨天') {?>
...
/<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_member_icon'];?>
',2);"/></a><i class="userresume_people_box_rt_tj"></i></div>
...
',2);"/>
            <p class="yun_text_color"><?php echo mb_substr($_smarty_tpl->tpl_vars['com']->value['name'],0,13,'utf-8');?>
</p>
            </a></li>
            <?php }
