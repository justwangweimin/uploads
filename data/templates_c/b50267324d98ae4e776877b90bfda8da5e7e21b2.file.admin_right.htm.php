<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-02-24 18:30:21
         compiled from "D:\xampp\htdocs\uploads\app\template\admin\admin_right.htm" */ ?>
<?php /*%%SmartyHeaderCode:702781475a913ebd173903-86600268%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b50267324d98ae4e776877b90bfda8da5e7e21b2' => 
    array (
      0 => 'D:\\xampp\\htdocs\\uploads\\app\\template\\admin\\admin_right.htm',
      1 => 1519467954,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '702781475a913ebd173903-86600268',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a913ebd20ca96_46009414',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a913ebd20ca96_46009414')) {function content_5a913ebd20ca96_46009414($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
>
    ...
    <body style="font-size:14px; padding-bottom:0; ">
        ...
        <div>
            ...
            <?php }?>
            <div class="admin_index_profit" style="display:none;">
                <div class="admin_index_profit_left">
                    <div class="admin_index_profit_list"><a href="###">
                            <div class="admin_index_profit_list_n">￥580.58</div>
                            <div class="admin_index_profit_list_p">本月收益</div>
                        </a></div>
                    <div class="admin_index_profit_list"><a href="###">
                            <div class="admin_index_profit_list_n">￥580.58</div>
                            <div class="admin_index_profit_list_p">增值套餐</div>
                        </a></div>
                    <div class="admin_index_profit_list"><a href="###">
                            <div class="admin_index_profit_list_n">￥580.58</div>
                            <div class="admin_index_profit_list_p">积分充值</div>
                        </a></div>
                    <div class="admin_index_profit_list"><a href="###">
                            <div class="admin_index_profit_list_n">￥580.58</div>
                            <div class="admin_index_profit_list_p">增值服务</div>
                        </a></div>
                </div>
                <div class="admin_index_user_sh">
                    <div class="admin_index_user_sh_list"><a href="###" class="admin_index_user_sh_list_a">sss</a></div>
                    <div class="admin_index_user_sh_list"><a href="###" class="admin_index_user_sh_list_a">sss</a></div>
                    <div class="admin_index_user_sh_list"><a href="###" class="admin_index_user_sh_list_a">sss</a></div>
                    <div class="admin_index_user_sh_list"><a href="###" class="admin_index_user_sh_list_a">sss</a></div>
                    <div class="admin_index_user_sh_list"><a href="###" class="admin_index_user_sh_list_a">sss</a></div>
                ...
                <div class="admin_index_data_list">
                    ...
                    <div class="admin_index_data_newlist">
                        <a href="index.php?m=company_order&typedd=1&order_state=2&time=1">
                            <div class="admin_index_data_new_p">增值套餐</div><div class="admin_index_statistics_n"><span class="admin_index_statistics_fh">￥</span><span id="ajax_money_vip">0</span></div>
                        </a>
                    </div>
                    <div class="admin_index_data_newlist">
            ...
            <div class="mainindex_box">
                <div class="mainindex_box_cont">
                    <div class="mainleft">
                        <div class="maininfo">
                            <div class="admin_indexdt"><div class="mainboxtop"><h6>软件消息</h6></div><ul class="" id="yunzx"></ul></div>
                        </div>
                    </div>                                

                    <div class="mainright">
                        <div class="maininfo">
                            <div class="mainboxtop"><h6>日日聘平台</h6></div>
                            <div class="maincontent">
                                <p>开发团队：王卫民团队</p>
                                <p>联系电话：0512-68095161</p>
                                <p>官方网站：<a href="http://localhost/uploads/" target="_blank">日日聘</a></p>
                                <p>咨询QQ：26206594</p>
                            </div>
                        </div>
                    </div> 
            ...
            <div class="mainindex_box" style="margin-top:20px;">
                <div class="mainindex_box_cont">
                    <div class="mainmsg">
                        ...
                        <div class="">
                            <span class="mainmsg_list">程序版本： <?php echo $_smarty_tpl->tpl_vars['version']->value;?>
</span>
                        </div>   
                    </div>
                </div> 
...
>
                    function dk(){
                        $("#edition_box_yun").show();
                        $(".edition_box_bg").show();
                    }
                    function gb(){
                        $("#edition_box_yun").hide();
                        $(".edition_box_bg").hide();
                    }
