<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-02-24 20:04:22
         compiled from "D:\xampp\htdocs\uploads\app\template\default\index\index.htm" */ ?>
<?php /*%%SmartyHeaderCode:19315235395a9154c6220ed0-40849797%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a860f44d0421036ccfa57e2a27238309cc0afdf0' => 
    array (
      0 => 'D:\\xampp\\htdocs\\uploads\\app\\template\\default\\index\\index.htm',
      1 => 1519354426,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19315235395a9154c6220ed0-40849797',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9154c6989750_99157385',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9154c6989750_99157385')) {function content_5a9154c6989750_99157385($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\xampp\\htdocs\\uploads\\app\\include\\libs\\plugins\\function.url.php';
...
if (!is_callable('smarty_function_webspecial')) include 'D:\\xampp\\htdocs\\uploads\\app\\include\\libs\\plugins\\function.webspecial.php';
				...
				if($paramer[noids]==1 && !empty($noids) && in_array($value['id'],$noids)){
					...
					if(is_array($urgent_list[$key]['welfare'])&&$urgent_list[$key]['welfare']){
						foreach($urgent_list[$key]['welfare'] as $val){
							...
							$urgent_list[$key]['welfarename'][]=$val;
						}
					}
...
<?php global $db,$db_config,$config;include PLUS_PATH.'/group.cache.php';$plist=array();$rs=null;$nids=null;eval('$paramer=array("pic"=>"1","limit"=>"4","item"=>"\'plist\'","key"=>"\'pkey\'","nocache"=>"")
;');
		$ParamerArr = GetSmarty($paramer,$_GET,$_smarty_tpl);
		$paramer = $ParamerArr['arr'];
		$Purl =  $ParamerArr['purl'];
...
"><?php echo mb_substr($_smarty_tpl->tpl_vars['plist']->value['title'],0,20,'utf-8');?>
</a></dd>
                            </dl>
                            <?php } else { ?>
