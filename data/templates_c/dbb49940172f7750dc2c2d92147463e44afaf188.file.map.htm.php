<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-03-07 12:16:31
         compiled from "D:\xampp\htdocs\uploads\app\template\wap\map.htm" */ ?>
<?php /*%%SmartyHeaderCode:9880389925a9f679fec1381-35123915%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dbb49940172f7750dc2c2d92147463e44afaf188' => 
    array (
      0 => 'D:\\xampp\\htdocs\\uploads\\app\\template\\wap\\map.htm',
      1 => 1515035054,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9880389925a9f679fec1381-35123915',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9f67a0089246_02427836',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9f67a0089246_02427836')) {function content_5a9f67a0089246_02427836($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\xampp\\htdocs\\uploads\\app\\include\\libs\\plugins\\function.url.php';
...
<header>
   <div class="header" >
    <div class="header_bg <?php if ($_smarty_tpl->tpl_vars['tplmoblie']->value['color']) {?>bg<?php echo $_smarty_tpl->tpl_vars['tplmoblie']->value['color'];
       ...
       <div class="header_h1"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</div> 
     </div>
  </div>
 </header>
...
<form id="map-search" class="on">
  ...
  <div id="search-q-wrapper">
      <input type="search" id="search-q" name="keyword" placeholder="企业名称" value="<?php echo $_GET['keyword'];?>
"/>
  </div>
...
<?php echo '<script'; ?>
 type="text/javascript">
	...
	var point = new BMap.Point(116.331398, 39.897445);   //设置中心点坐标
...
'</div>';
	...
	var map = new BMap.Map("allmap");            
	    ...
	    $.post('<?php echo smarty_function_url(array('m'=>'wap','c'=>'map','a'=>'joblist'),$_smarty_tpl);?>
', {minx:a.lng,maxx:d.lng,miny:a.lat,maxy:d.lat, page: page, keyword: '<?php echo $_GET['keyword'];?>
', r: zoom }, function (data) {
