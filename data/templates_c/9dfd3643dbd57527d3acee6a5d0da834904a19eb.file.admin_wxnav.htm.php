<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-02-25 09:26:05
         compiled from "D:\xampp\htdocs\uploads\app\template\admin\admin_wxnav.htm" */ ?>
<?php /*%%SmartyHeaderCode:11488687385a9210ad9944f6-09614990%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9dfd3643dbd57527d3acee6a5d0da834904a19eb' => 
    array (
      0 => 'D:\\xampp\\htdocs\\uploads\\app\\template\\admin\\admin_wxnav.htm',
      1 => 1517041898,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11488687385a9210ad9944f6-09614990',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9210adbcf8c0_57545046',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9210adbcf8c0_57545046')) {function content_5a9210adbcf8c0_57545046($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
function editnav(id,name,keyid,keyname,key,type,url,sort){	
	$("#navid").val(id);
	$("input[name='add_name']").val(name);	
	$("input[name='add_sort']").val(sort);
	
	//$("#add_keyid_val").next().find("dd[lay-value='"+keyid+"']").click();
	$("#add_keyid_val").val(keyid);
	//$("#add_type_val").next().find("dd[lay-value='"+type+"']").click();
	$("#add_type_val").val(type);
	layui.form.render('select');
	$("input[name='add_url']").val(url);
	$("input[name='add_key']").val(key);
	
	add_class('修改微信菜单','400','400','#houtai_div','');
}

function addnav(){	
	
	clearnav();
	add_class('新增微信菜单','400','400','#houtai_div','');
...
<a  href="javascript:void(0)" onClick="addnav();" class="admin_infoboxp_tj">增加微信菜单</a>
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
			...
			<tr class="ui_td_11">
                ...
                <div class="layui-form-item">
                  <div class="layui-input-block">
                     <div class="layui-input-inline">
                       <select name="add_type"  lay-filter="" id="add_type_val">
			...
			<tr class="ui_td_11 ">
                ...
                <input class="layui-btn layui-btn-normal" type="button" name="add" value=" 确认 " onClick="save_industry()" /></td>
			</tr> 
		</tbody>
	</table>
</form>
