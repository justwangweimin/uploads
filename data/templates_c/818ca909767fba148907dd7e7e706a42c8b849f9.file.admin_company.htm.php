<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-02-24 18:31:29
         compiled from "D:\xampp\htdocs\uploads\app\template\admin\admin_company.htm" */ ?>
<?php /*%%SmartyHeaderCode:7843784395a913f010ad607-47699913%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '818ca909767fba148907dd7e7e706a42c8b849f9' => 
    array (
      0 => 'D:\\xampp\\htdocs\\uploads\\app\\template\\admin\\admin_company.htm',
      1 => 1517927463,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7843784395a913f010ad607-47699913',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a913f0133da94_71047562',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a913f0133da94_71047562')) {function content_5a913f0133da94_71047562($_smarty_tpl) {?><?php if (!is_callable('smarty_function_searchurl')) include 'D:\\xampp\\htdocs\\uploads\\app\\include\\libs\\plugins\\function.searchurl.php';
...
<div class="admin_userinfo_box_qyname">【操作对象】：<span class="admin_userinfo_box_qyname_s" id="m_name"></span><span class="admin_userinfo_box_useruid">【顾问姓名】：<em id="m_adviser"></em></span><span class="admin_userinfo_box_useruid">【用户IP】：<em ><?php echo $_smarty_tpl->tpl_vars['v']->value['login_ip'];?>
</em></span></div>
</div>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['v']->value['username'];?>
            ...
            <div  class="mt5"><a href="<?php echo smarty_function_url(array('m'=>'company','c'=>'show','id'=>$_smarty_tpl->tpl_vars['v']->value['uid']),$_smarty_tpl);?>
...
】<?php }?></a></div>
			...
			<td align="left">
				<?php if ($_smarty_tpl->tpl_vars['v']->value['vip_etime']<time()&&$_smarty_tpl->tpl_vars['v']->value['vip_time']!=0) {?>
					...
					<?php }?>
				<?php } else { ?>
                    <?php if ($_smarty_tpl->tpl_vars['v']->value['rating_name']=='非会员') {?>
					 <b style="color:red;"><?php echo $_smarty_tpl->tpl_vars['v']->value['rating_name'];?>
</b>
                    <?php } else { ?>
...
" href="javascript:void(0);" class="comrating"><span class="admin_company_xg_icon">[修改]</span></a>
				<?php if ($_smarty_tpl->tpl_vars['v']->value['vip_etime']) {?>
                    <?php if (smarty_modifier_date_format(time(),"%Y-%m-%d")<=smarty_modifier_date_format($_smarty_tpl->tpl_vars['v']->value['vip_etime'],"%Y-%m-%d")) {?>
...
','index.php?m=admin_company&c=checksitedid');" class="admin_company_xg_icon">重新分配</a></div>
            ...
            <td>
             <div class="admin_new_bth_c"> <a  href="javascript:;" onclick="manage('<?php echo $_smarty_tpl->tpl_vars['v']->value['uid'];?>
','<?php echo smarty_function_url(array('m'=>'company','c'=>'show','id'=>$_smarty_tpl->tpl_vars['v']->value['uid']),$_smarty_tpl);?>
')" class="admin_new_c_bth admin_new_c_bthsh" >管理</a> </div>
                          <div class="admin_new_bth_c"> <a href="javascript:void(0)"  onclick="layer_del('确定要删除？', 'index.php?m=admin_company&c=del&del=<?php echo $_smarty_tpl->tpl_vars['v']->value['uid'];?>
');" class="admin_new_c_bth admin_new_c_bth_sc" >删除</a> </div>
         ...
         <label for="chkAll2">全选</label>
          ...
          <?php if ($_smarty_tpl->tpl_vars['email_promiss']->value) {?> <input class="admin_button" type="button" value="发邮件"  onclick="return confirm_email('确定发邮件吗？','email_div')"/><?php }?>
		   <?php if ($_smarty_tpl->tpl_vars['moblie_promiss']->value) {?><input class="admin_button" type="button" value="发信息"  onclick="return confirm_email('确定发信息吗？','moblie_div')"/><?php }?>
