<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-03-07 11:40:17
         compiled from "D:\xampp\htdocs\uploads\app\template\default\company\index.htm" */ ?>
<?php /*%%SmartyHeaderCode:19441850885a9f5f2102ecd7-05292334%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3fc53d84bb4c88d524883c21f51acfeb5d0197e9' => 
    array (
      0 => 'D:\\xampp\\htdocs\\uploads\\app\\template\\default\\company\\index.htm',
      1 => 1517641980,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19441850885a9f5f2102ecd7-05292334',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9f5f2143b326_04169175',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9f5f2143b326_04169175')) {function content_5a9f5f2143b326_04169175($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\xampp\\htdocs\\uploads\\app\\include\\libs\\plugins\\function.url.php';
if (!is_callable('smarty_function_listurl')) include 'D:\\xampp\\htdocs\\uploads\\app\\include\\libs\\plugins\\function.listurl.php';
?><?php global $db,$db_config,$config;eval('$paramer=array("ispage"=>"1","isjob"=>"1","firm"=>"1","hy"=>"\'auto.hy\'","pr"=>"\'auto.pr\'","mun"=>"\'auto.mun\'","welfare"=>"\'auto.welfare\'","provinceid"=>"\'auto.provinceid\'","cityid"=>"\'auto.cityid\'","three_cityid"=>"\'auto.three_cityid\'","keyword"=>"\'auto.keyword\'","rec"=>"\'auto.rec\'","order"=>"\'lastupdate\'","limit"=>"20","item"=>"\'lists\'","key"=>"\'key\'","nocache"=>"")
;');$lists=array();
		...
		if($paramer['ltjob']){
			...
			if(is_array($ListId) && is_array($JobList)){
				foreach($lists as $key=>$value){
					$jobname="";
                    $lists[$key]['ltjobnum'] = 0;
					foreach($JobList as $k=>$v){
						if($lists[$key]['ltjobnum']>=$paramer['ltjob']){continue;}
						if($value['uid']==$v['uid']){
							$url = Url("lietou",array("c"=>"jobcomshow","id"=>$v['id']));
							$v['job_url'] = $url;
							$jobname[] = "<a href='".$url."'>".$v['job_name']."</a>";
                            $lists[$key]['ltjoblist'][] = $v;
                            $lists[$key]['ltjobnum'] = $lists[$key]['ltjobnum']+1;
						}
					}
					$lists[$key]['ltjob'] = @implode(",",$jobname);
				}
			}
		}
...
',2);" />
		...
		<div class="firm_list_rightsidebar">
			<div class="firm_name">
				<span>
					<a href='<?php echo $_smarty_tpl->tpl_vars['lists']->value['com_url'];?>
' target="_blank" class="firm_name_a"><?php echo mb_substr($_smarty_tpl->tpl_vars['lists']->value['name'],0,25,'utf-8');?>
</a>
					<?php if ($_smarty_tpl->tpl_vars['lists']->value['rec']) {?><img src="<?php echo $_smarty_tpl->tpl_vars['style']->value;?>
/images/firm_icon.png"/><?php }?>
					<?php if ($_smarty_tpl->tpl_vars['lists']->value['ratlogo']!=''&&$_smarty_tpl->tpl_vars['lists']->value['ratlogo']!="0") {?><img src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
