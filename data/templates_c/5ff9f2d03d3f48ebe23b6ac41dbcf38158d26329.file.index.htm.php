<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-02-25 09:44:12
         compiled from "D:\xampp\htdocs\uploads\app\template\default\article\index.htm" */ ?>
<?php /*%%SmartyHeaderCode:14108461885a9214ecb7d017-32873137%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5ff9f2d03d3f48ebe23b6ac41dbcf38158d26329' => 
    array (
      0 => 'D:\\xampp\\htdocs\\uploads\\app\\template\\default\\article\\index.htm',
      1 => 1517816803,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14108461885a9214ecb7d017-32873137',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9214ecc93201_81786044',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9214ecc93201_81786044')) {function content_5a9214ecc93201_81786044($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\xampp\\htdocs\\uploads\\app\\include\\libs\\plugins\\function.url.php';
...
<?php global $db,$db_config,$config;include PLUS_PATH.'/group.cache.php';$newarticle=array();$rs=null;$nids=null;eval('$paramer=array("limit"=>"20","item"=>"\'newarticle\'","nocache"=>"")
;');
		$ParamerArr = GetSmarty($paramer,$_GET,$_smarty_tpl);
		$paramer = $ParamerArr['arr'];
		$Purl =  $ParamerArr['purl'];
...
<?php global $db,$db_config,$config;include PLUS_PATH.'/group.cache.php';$alist=array();$rs=null;$nids=null;eval('$paramer=array("item"=>"\'alist\'","t_len"=>"15","order"=>"\'hits\'","limit"=>"10","key"=>"\'key\'","name"=>"\'newlist1\'","nocache"=>"")
;');
		$ParamerArr = GetSmarty($paramer,$_GET,$_smarty_tpl);
		$paramer = $ParamerArr['arr'];
		$Purl =  $ParamerArr['purl'];
...
<?php global $db,$db_config,$config;include PLUS_PATH.'/group.cache.php';$news=array();$rs=null;$nids=null;eval('$paramer=array("limit"=>"8","urlstatic"=>"1","type"=>"\'tj\'","item"=>"\'news\'","nocache"=>"")
;');
		$ParamerArr = GetSmarty($paramer,$_GET,$_smarty_tpl);
		$paramer = $ParamerArr['arr'];
		$Purl =  $ParamerArr['purl'];
...
/<?php echo $_smarty_tpl->tpl_vars['newarticle']->value['s_thumb'];?>
"width="150" height="100" onerror="showImgDelay(this,'<?php echo $_smarty_tpl->tpl_vars['style']->value;?>
/images/nopic.gif',2);" alt="<?php echo $_smarty_tpl->tpl_vars['newarticle']->value['title'];?>
"/></a></div>
...
<?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/js/layer/layer.min.js?v=<?php echo $_smarty_tpl->tpl_vars['config']->value['cachecode'];?>
" language="javascript"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
