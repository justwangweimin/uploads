...
function fun_url_ck(){
    //网址例子：http://www.just.edu.cn:8888/ddd/ddd/abc.php
    //"\\1" 第一个分组，等价于"$1"或者"${1}"
...
<title>JUST系统安装程序'.VERSION.'</title>
...
<div class="wrap">
	...
	<div class="version">JUST系统安装程序'.VERSION.'</div>
</div>';
}
function show_footer(){
    echo '<div class="footer">
		Powered by <a href="http://www.just.edu.cn" style="color:blue;">王卫民</a> '.VERSION.' &copy;'.YEAR.'
	</div>
</div>
</div>
</body>
...
function show_env_result(&$env_items,&$dirfile_items,&$func_items){
    ...
    if(KEKE_OFF){
        ...
        echo '<table width="100%"><tbody><tr><td class="td1"width="161px">环境检测</td><td class="td1" width="161px">当前服务器</td><td class="td1" width="161px">JUST最佳</td></tr>';
        echo $env_str;
        echo '</tbody></table>';
