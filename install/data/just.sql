...
--
-- 表的结构 `just_admin_announcement`
--

CREATE TABLE `just_admin_announcement` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_admin_config`
--

CREATE TABLE `just_admin_config` (
...
--
-- 表的结构 `just_admin_email`
--

CREATE TABLE `just_admin_email` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_admin_link`
--

CREATE TABLE `just_admin_link` (
...
--
-- 表的结构 `just_admin_navigation`
--

CREATE TABLE `just_admin_navigation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_admin_template`
--

CREATE TABLE `just_admin_template` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_admin_user`
--
CREATE TABLE `just_admin_user` (
...
--
-- 表的结构 `just_admin_user_group`
--

CREATE TABLE `just_admin_user_group` (
...
--
-- 表的结构 `just_advice_question`
--

CREATE TABLE `just_advice_question` (
...
--
-- 表的结构 `just_answer_review`
--

CREATE TABLE `just_answer_review` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) NOT NULL,
...
--
-- 表的结构 `just_city_class`
--

CREATE TABLE `just_city_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_company_cert`
--

CREATE TABLE `just_company_cert` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_company_consultant`
--

CREATE TABLE `just_company_consultant` (
...
--
-- 表的结构 `just_company_job`
--

CREATE TABLE `just_company_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL DEFAULT '',
...
--
-- 表的结构 `just_company_job_rewardlist`
--
CREATE TABLE `just_company_job_rewardlist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_company_job_rewardlog`
--
CREATE TABLE `just_company_job_rewardlog` (
`id`  int(11) NOT NULL AUTO_INCREMENT,
`rewardid`  int(11) NULL DEFAULT NULL,
`jobid`  int(11) NOT NULL ,
`eid`  int(11) NULL DEFAULT NULL,
`ostatus`  int(11) NULL DEFAULT NULL,
`status`  int(11) NULL DEFAULT NULL,
`uid`  int(11) NULL DEFAULT NULL,
`utype`  int(11) NULL DEFAULT NULL,
`ctime`  int(11) NULL DEFAULT NULL,
`pay`  double(10,2) NULL DEFAULT 0.00,
`loginfo`  text NULL DEFAULT NULL,
`arbpic`  varchar(100) NULL DEFAULT NULL,
...
--
-- 表的结构 `just_company_job_share`
--
CREATE TABLE `just_company_job_share` (
`id`  int(11) NOT NULL AUTO_INCREMENT ,
`uid`  int(11) NOT NULL ,
`jobid`  int(11) NOT NULL ,
`packmoney`  double(10,2) NOT NULL ,
`packnum`  int(11) NOT NULL ,
`packprice`  double(10,2) NULL DEFAULT 0.00,
`stime`  int(11) NULL DEFAULT NULL ,
PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;
...
--
-- 表的结构 `just_company_job_sharelog`
--
CREATE TABLE `just_company_job_sharelog` (
`id`  int(11) NOT NULL AUTO_INCREMENT ,
`uid`  int(11) NOT NULL ,
`comid`  int(11) NULL DEFAULT NULL,
`jobid`  int(11) NOT NULL,
`jobname`  varchar(100) NULL DEFAULT NULL ,
`packmoney`  double(10,2) NULL DEFAULT 0.00 ,
`wxname`  varchar(100) NULL DEFAULT NULL ,
...
--
-- 表的结构 `just_company_job_link`
--

CREATE TABLE `just_company_job_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `jobid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_company_msg`
--

CREATE TABLE `just_company_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_company_news`
--

CREATE TABLE `just_company_news` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_company_order`
--

CREATE TABLE `just_company_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
--
-- 表的结构 `just_company_pay`
--

CREATE TABLE `just_company_pay` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_company_product`
--

CREATE TABLE `just_company_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `title` varchar(200) DEFAULT '0',
...
--
-- 表的结构 `just_company_rating`
--

CREATE TABLE `just_company_rating` (
...
--
-- 表的结构 `just_company_service`
--

CREATE TABLE `just_company_service` (
...
--
-- 表的结构 `just_company_service_detail`
--

CREATE TABLE `just_company_service_detail` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `service_price` varchar(100) DEFAULT NULL,
  `resume` int(5) DEFAULT NULL,
  `interview` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_company_show`
--

CREATE TABLE `just_company_show` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_company_statis`
--

CREATE TABLE `just_company_statis` (
  `uid` int(11) NOT NULL,
...
--
-- 表的结构 `just_company_tpl`
--

CREATE TABLE `just_company_tpl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_coupon_list`
--

CREATE TABLE `just_coupon_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
--
-- 表的结构 `just_crmnew_concern`
--

CREATE TABLE `just_crmnew_concern` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL DEFAULT '0',
...
--
-- 表的结构 `just_crmnew_return_visit`
--

CREATE TABLE `just_crmnew_return_visit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `comid` int(11) NOT NULL DEFAULT '0',
...
--
-- 表的结构 `just_description`
--

CREATE TABLE `just_description` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_desc_class`
--

CREATE TABLE `just_desc_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `sort` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
...
--
-- 表的结构 `just_down_resume`
--

CREATE TABLE `just_down_resume` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `eid` int(11) DEFAULT NULL,
  `comid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_evaluate_group`
--

CREATE TABLE `just_evaluate_group` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_evaluate_leave_message`
--

CREATE TABLE `just_evaluate_leave_message` (
...
--
-- 表的结构 `just_evaluate_log`
--

CREATE TABLE `just_evaluate_log` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_friend_state`
--

CREATE TABLE `just_friend_state` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_invoice_record`
--

CREATE TABLE `just_invoice_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_look_resume`
--

CREATE TABLE `just_look_resume` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `com_id` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_lthy_class`
--

CREATE TABLE `just_lthy_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `sort` int(11) NOT NULL,
...
--
-- 表的结构 `just_ltjob_class`
--

CREATE TABLE `just_ltjob_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `sort` int(11) NOT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='用户成员表（个人用户、企业用户、猎头用户）' AUTO_INCREMENT=1;

-- --------------------------------------------------------

--
-- 表的结构 `just_member_log`
--

CREATE TABLE `just_member_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_member_reg`
--

CREATE TABLE `just_member_reg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_member_statis`
--

CREATE TABLE `just_member_statis` (
  `uid` int(11) NOT NULL,
  `integral` varchar(10) NOT NULL DEFAULT '',
  `pay` double(10,2) NOT NULL DEFAULT '0.00',
  `packpay` double(10,2) DEFAULT '0.00',
...
--
-- 表的结构 `just_member_withdraw`
--

CREATE TABLE `just_member_withdraw` (
`id`  int(11) NOT NULL AUTO_INCREMENT ,
`order_id`  varchar(50)  NOT NULL ,
`price`  double(10,2) NULL DEFAULT 0.00,
`order_price`  double(10,2) NOT NULL DEFAULT 0.00,
`pound_price`  double(10,2) NULL DEFAULT 0.00,
`uid`  int(11) NOT NULL ,
`usertype`  int(11) NULL DEFAULT NULL,
...
--
-- 表的结构 `just_moblie_msg`
--

CREATE TABLE `just_moblie_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
  `cuid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_navigation`
--

CREATE TABLE `just_navigation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nid` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
...
--
-- 表的结构 `just_navigation_type`
--

CREATE TABLE `just_navigation_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_news_content`
--

CREATE TABLE `just_news_content` (
...
--
-- 表的结构 `just_news_group`
--

CREATE TABLE `just_news_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `sort` int(11) DEFAULT '0',
...
--
-- 表的结构 `just_part_apply`
--

CREATE TABLE `just_part_apply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `jobid` int(11) DEFAULT NULL,
  `comid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_part_collect`
--

CREATE TABLE `just_part_collect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `jobid` int(11) DEFAULT NULL,
  `comid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_prepaid_card`
--

CREATE TABLE `just_prepaid_card` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `just_recommend` (
`id`  int(11) NOT NULL AUTO_INCREMENT ,
`uid`  int(11) NOT NULL DEFAULT 0,
`rec_type`  tinyint(1) NULL DEFAULT NULL,
...
--
-- 表的结构 `just_redeem_class`
--

CREATE TABLE `just_redeem_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `sort` int(11) NOT NULL,
...
--
-- 表的结构 `just_resume_cert`
--

CREATE TABLE `just_resume_cert` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL DEFAULT '',
...
--
-- 表的结构 `just_resume_doc`
--

CREATE TABLE `just_resume_doc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `doc` text,
...
--
-- 表的结构 `just_resume_edu`
--

CREATE TABLE `just_resume_edu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL DEFAULT '',
...
--
-- 表的结构 `just_resume_expect`
--

CREATE TABLE `just_resume_expect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL DEFAULT '',
  `hy` int(5) DEFAULT NULL,
...
--
-- 表的结构 `just_resume_other`
--

CREATE TABLE `just_resume_other` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL DEFAULT '',
...
--
-- 表的结构 `just_resume_project`
--

CREATE TABLE `just_resume_project` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL DEFAULT '',
...
--
-- 表的结构 `just_resume_show`
--

CREATE TABLE `just_resume_show` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_resume_skill`
--

CREATE TABLE `just_resume_skill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL DEFAULT '',
...
--
-- 表的结构 `just_resume_tiny`
--

CREATE TABLE `just_resume_tiny` (
  `id` int(25) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_resume_training`
--

CREATE TABLE `just_resume_training` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
  `name` varchar(25) NOT NULL DEFAULT '',
...
--
-- 表的结构 `just_resume_work`
--

CREATE TABLE `just_resume_work` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `eid` int(11) NOT NULL,
...
--
-- 表的结构 `just_reward_class`
--

CREATE TABLE `just_reward_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;
...
--
-- 表的结构 `just_special_com`
--

CREATE TABLE `just_special_com` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sid` int(11) DEFAULT NULL,
  `uid` int(11) DEFAULT NULL,
  `integral` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_subscriberecord`
--

CREATE TABLE `just_subscriberecord` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sid` int(11) DEFAULT NULL,
  `uid` int(11) DEFAULT NULL,
  `content` varchar(255) DEFAULT NULL,
...
--
-- 表的结构 `just_talent_pool`
--

CREATE TABLE `just_talent_pool` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `eid` int(11) DEFAULT NULL,
  `cuid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_temporary_resume`
--

CREATE TABLE `just_temporary_resume` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT NULL,
...
--
-- 表的结构 `just_toolbox_class`
--

CREATE TABLE `just_toolbox_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL,
  `content` text,
  `pic` varchar(100) DEFAULT NULL,
...
--
-- 表的结构 `just_toolbox_doc`
--

CREATE TABLE `just_toolbox_doc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_tplmobliepic`
--

CREATE TABLE `just_tplmobliepic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL DEFAULT '',
  `pic` varchar(200) NOT NULL DEFAULT '',
...
--
-- 表的结构 `just_userid_job`
--

CREATE TABLE `just_userid_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
--
-- 表的结构 `just_userid_msg`
--

CREATE TABLE `just_userid_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
--
-- 表的结构 `just_user_entrust`
--

CREATE TABLE `just_user_entrust` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `username` varchar(255) DEFAULT NULL,
  `eid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_user_entrust_record`
--

CREATE TABLE `just_user_entrust_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `eid` int(11) DEFAULT NULL,
  `comid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_user_resume`
--

CREATE TABLE `just_user_resume` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL,
  `eid` int(10) NOT NULL,
...
--
-- 表的结构 `just_webscan360`
--

CREATE TABLE `just_webscan360` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `just_wxzdkeyword`
--

CREATE TABLE `just_wxzdkeyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL,
  `keyword` text,
  `content` text,
...
--
-- 表的结构 `just_zhaopinhui`
--

CREATE TABLE `just_zhaopinhui` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) DEFAULT '0',
  `sid` int(11) DEFAULT NULL,
...
--
-- 表的结构 `just_zhaopinhui_com`
--

CREATE TABLE `just_zhaopinhui_com` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
...
--
-- 表的结构 `just_zhaopinhui_pic`
--

CREATE TABLE `just_zhaopinhui_pic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) NOT NULL DEFAULT '',
  `pic` varchar(200) NOT NULL DEFAULT '',
  `sort` int(11) DEFAULT '0',
...
--
-- 表的结构 `just_zhaopinhui_space`
--

CREATE TABLE `just_zhaopinhui_space` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) DEFAULT NULL,
  `sort` int(11) DEFAULT '0',
  `keyid` int(11) DEFAULT '0',
