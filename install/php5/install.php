...
if(file_exists(S_ROOT."/data/just.lock")){
    show_view('<div class="centent"><div class="step"><div class="server"><table width="100%"><tbody><tr><td class="td1" width="100">提示信息</td><td class="td1" width="200">&nbsp;</td><td class="td1">&nbsp;</td></tr><tr><td colspan="3" style="width:100%;">你已经安装过JUST系统，请删除just.lock文件再安装！</td></tr></tbody></table></div></div></div>');
    exit();
}
if(empty($_GET['step']))
    $_GET['step']='start';
...
<div class="bottom">
    ...
    $fp=@file_get_contents("data/just.sql");
    ...
    $fpp=@file_get_contents("data/just_data.sql");
