...
class job_controller extends common{
	...
	function view_action(){
		...
		$company=$UserinfoM->GetUserinfoOne(array('uid'=>$job['uid']),array('field'=>"`shortname`,`ant_num`,`name`,`pr`,`mun`,`hy`,`linkqq`,`logo`,`address`,`busstops`,`linktel`,`linkman`,`linkphone`,`email_status`,`moblie_status`,`yyzz_status`,`content`,`x`,`y`","usertype"=>2));
		...
		if(strpos($_SERVER['HTTP_REFERER'],'ajaxreward')){
