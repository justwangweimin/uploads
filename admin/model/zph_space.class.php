...
class zph_space_controller extends adminCommon{
	...
	function save_action(){
	    ...
	    $content=str_replace("&amp;","&",html_entity_decode($_POST['content'],ENT_QUOTES));
	...
	function ajax_action(){
		...
		if($_POST['price']){ 
			$this->obj->DB_update_all("zhaopinhui_space","`price`='".$_POST['price']."'","`id`='".$_POST['id']."'");
			$this->model('log')->admin_log("修改展位(ID:".$_POST['id'].")价格");
		}
		echo '1';die;
	}
}
