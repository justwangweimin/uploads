...
class advertise{
    ...
    function model_saveadd_action($post,$pic=NULL){
        ...
        $value="`ad_name`='$ad_name',`target`='$target',`time_start`='$add_time_start',`time_end`='$add_time_end',`ad_type`='$ad_type',`class_id`='$class_id',`is_check`='1',`did`='$did',`is_open`='$is_open',`sort`='".$sort."',`remark`='".$remark."'";
        if($ad_type=="word"){
            if($pic!=""){
                $word_url=$pic;
            }
    ...
    function model_modify_save_action($post,$pic){
        ...
        $value="`ad_name`='$ad_name',`target`='$target',`time_start`='$ad_time_start',`time_end`='$ad_time_end',`ad_type`='$ad_type',`class_id`='$class_id',`did`='$did',`is_open`='$is_open',`sort`='".$sort."',`remark`='".$remark."'";
        if($ad_type=="word"){
            if($pic!=""){
                $word_url=$pic;
            }
