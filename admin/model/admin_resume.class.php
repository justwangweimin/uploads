...
class admin_resume_controller extends adminCommon{
	...
	function status_action(){ 
		...
		$id=(int)$_POST['id'];
 		$nid=$this->obj->DB_update_all("resume_expect","`r_status`='".$_POST['status']."',`statusbody`='".$statusbody."'","`id`='".$id."'");

 		$nid?$this->ACT_layer_msg("简历审核(ID:".$id.")设置成功！",9,$_SERVER['HTTP_REFERER'],2,1):$this->ACT_layer_msg( "设置失败！",8,$_SERVER['HTTP_REFERER']);
	}
