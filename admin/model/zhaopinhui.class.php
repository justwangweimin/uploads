...
class zhaopinhui_controller extends adminCommon{
	...
	function save_action(){
		...
		$_POST['body']=str_replace("&amp;","&",html_entity_decode($_POST['body'],ENT_QUOTES));
		$_POST['media']=str_replace("&amp;","&",html_entity_decode($_POST['media'],ENT_QUOTES));
		$_POST['packages']=str_replace("&amp;","&",html_entity_decode($_POST['packages'],ENT_QUOTES));
		$_POST['booth']=str_replace("&amp;","&",html_entity_decode($_POST['booth'],ENT_QUOTES));
		$_POST['participate']=str_replace("&amp;","&",html_entity_decode($_POST['participate'],ENT_QUOTES));
